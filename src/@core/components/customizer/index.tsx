...
import primaryColorConfig, { type PrimaryColorConfig } from '@configs/primaryColorConfig'
// Type Imports
...
const Customizer = ({
  ...
  return (
    !breakpointReached && (
      <div
        className={clsx('customizer', styles.customizer, {
          [styles.show]: isOpen,
        ...
        <div className={clsx('customizer-header flex items-center justify-between', styles.header)}>
          ...
          <div className='flex gap-4'>
            <div onClick={resetSettings} className='relative flex cursor-pointer'>
              ...
              <div className={clsx(styles.dotStyles, { [styles.show]: isSettingsChanged })} />
            </div>
        ...
        <ScrollWrapper
          ...
          <div className={clsx('customizer-body flex flex-col', styles.customizerBody)}>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  {primaryColorConfig.map((item) => (
                    <div
                      key={item.main}
                      className={clsx(styles.primaryColorWrapper, {
                  ...
                  <div
                    ...
                    <div
                      className={clsx(styles.primaryColor, 'flex items-center justify-center')}
                      style={{
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
                      className={clsx(styles.itemWrapper, styles.modeWrapper, {
