...
import { clockIn } from '@api/schedule'
...
export const ModalClockIn = ({ show, setShow, data }: Props) => {
  const { mutateAsync }: any = clockIn(data?.id)
      ...
      <DialogContent className='sm:p-16'>
        ...
        <div className='text-center'>
          ...
          <div className='font-medium mt-2 text-[12pt]'>
            Are you sure want to Clock-In at {data?.placeName} with {data?.clientName} ?
          </div>
        </div>
      </DialogContent>
      <DialogActions>
