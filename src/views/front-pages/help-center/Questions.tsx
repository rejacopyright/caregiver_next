...
const Questions = () => {
  ...
  return (
    <section className='flex flex-col justify-center items-center gap-4 md:plb-[100px] plb-[50px] bg-backgroundPaper pbs-[70px] -mbs-[70px]'>
      <div className={clsx('pbs-10 md:pbs-16', frontCommonStyles.layoutSpacing)}>
        <Grid container spacing={6}>
          <Grid size={{ xs: 12, lg: 8 }}>
            <div className='flex flex-col gap-2'>
              <Breadcrumbs aria-label='breadcrumb'>
                <Link className='hover:text-primary' href={`${landingUrl}/help-center`}>
                  Help Center
                </Link>
            ...
            <div className='flex flex-col gap-6'>
              <div>
                ...
                <Typography>
                  If you want several items, use the &apos;Add to Cart&apos; button and then choose
                  &apos;Keep Browsing&apos; to continue shopping or &apos;Checkout&apos; to finalize
                  your purchase.
                </Typography>
              </div>
              <img
              ...
              />
              <Typography>
                You can go back to your cart at any time by clicking on the shopping cart icon at
