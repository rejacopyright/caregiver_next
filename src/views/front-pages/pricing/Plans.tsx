      ...
      <div className={frontCommonStyles.layoutSpacing}>
        ...
        <div className='overflow-x-auto border rounded'>
          <table className={tableStyles.table}>
            <thead className={clsx('border-be', styles.tableHead)}>
              <tr>
                <th>Time</th>
                <th>
                  STARTER
            ...
            <tbody className={clsx('border-be', styles.tableBody)}>
              ...
              <tr>
                ...
                {plans.map((plan, index) => (
                  <td key={index} className='text-center plb-[9px]'>
                    <Button component={Link} href={`${landingUrl}/payment`} variant={plan.variant}>
                      {plan.label}
                    </Button>
                  </td>
                ))}
