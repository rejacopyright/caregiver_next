...
export const confirmUrlInChildren = (children: ChildrenType['children'], url: string): boolean => {
  ...
  if (isValidElement(children)) {
    ...
    } = children.props as typeof children.props & {
      component?: ReactElement & { props: { href?: string } }
      href?: string
      exactMatch?: boolean
      activeUrl?: string
...
const processMenuChildren = (
  ...
  return Children.map(children, (child) => {
    ...
    const childProps = child.props as typeof child.props & { menuData?: any }

    return childProps?.menuData ? (
      <GenerateVerticalMenu menuData={childProps.menuData} />
    ) : (
      mapFunction(child)
    )
  })
...
export const mapHorizontalToVerticalMenu = (children: ReactNode): ReactNode => {
  return Children.map(children, (child) => {
    ...
    const {
      ...
      verticalMenuProps,
      ...rest
    } = child.props as typeof child.props & {
      children?: ChildrenType['children']
      verticalMenuProps?: {
        [key: string]: any
      }
    ...
    switch (child.type) {
      ...
      case HorizontalSubMenu:
        ...
        return (
          <VerticalSubMenu label={undefined} {...rest}>
